        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Request For Points</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($pointRequests as $key => $value)
                  <tr class="row-{{ $value->id }}">
                    ...
                    <td>
                     ...
                     <a href="javascript:void(0)" data-id="{{ $value->id }}" class="point-request"  > <span class="badge bg-blue">Action</span> </a>
                      ...
                      <a href="javascript:void(0)" data-id="{{ $value->user_id }}" class="pointTransfer-openModal"  > <span class="badge bg-blue">Point Deposit</span> </a>
