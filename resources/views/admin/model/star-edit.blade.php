 <div class="modal fade" id="star-edit-modal">
            ...
            <div class="modal-content">
              ...
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="title" class="col-sm-3 control-label">Game Status</label>
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn bg-purple  star-game-update">Update</button>
              </div>
