 <div class="modal fade" id="game-modal">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
               <form class="form-horizontal">
                ...
                <div class="form-group">
                <label for="pana" class="col-sm-3 control-label">select Date</label>

                  <div class="col-sm-9">
                  @if($flag != null)
                  @if($flag == 'open')
         
                  <input type="date" class="form-control" value="<?php echo date('Y-m-d'); ?>"  id="open_input_result_date"  name="open_input_result_date"> 
          ...
          <!-- <input type="datetime-local" value="<?php echo date("Y-m-d H:i",strtotime("now")); ?>"  class="form-control"  id="open_input_result_date" name="open_input_result_date"> -->
                  ...
                  @elseif($flag == 'close')
                  <input type="date" value="<?php echo date('Y-m-d'); ?>"  class="form-control" id="close_input_result_date"name="close_input_result_date"> 

                <!-- <input type="datetime-local" value="<?php echo date("Y-m-d H:i",strtotime("now")); ?>"  class="form-control"  id="close_input_result_date" name="close_input_result_date"> -->
              ...
              <button type="button"   data-dismiss="modal"  class="btn btn-default">Close</button>
                <button type="button" onclick="myFunction()" class="btn bg-purple update-pana">Update</button>
              </div>
